...
#FOR XENIA'26 HACKATHON PUNE INSTITUTE OF COMPUTER TECHNOLOGY 
...
```text
     ...
     ▼                     ▼                     ▼
┌─────────────┐    ┌──────────────┐    ┌────────────────┐
│ Research AI │    │ Lead Scoring │    │ Outreach Agent │
│    Agent    │    │    Agent     │    │      AI        │
└──────┬──────┘    └──────┬───────┘    └────────┬───────┘
       │                  │                     │
       ▼                  ▼                     ▼
 Lead Discovery     Lead Qualification     Email/Message
 Data Collection      Priority Analysis      Automation
...
START
  │
  ▼
User Inputs Business Criteria
  │
  ▼
AI Research Agent Finds Leads
  │
  ▼
